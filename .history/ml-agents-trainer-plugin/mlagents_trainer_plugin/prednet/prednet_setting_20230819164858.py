...
# class PrednetSettings(HyperparamSettings):
#     # Define any settings required for your trainer here.
#     # It seems you don't need any hyperparameters, so this can be empty for now.
#     pass
...
class PrednetSettings(OffPolicyHyperparamSettings):
    gamma: float = 0.99
...
class PrednetOptimizer(TorchOptimizer):
    def __init__(self, policy: TorchPolicy, trainer_settings: TrainerSettings):
        ...
        self.hyperparameters: PrednetSettings = cast(
            PrednetSettings, trainer_settings.hyperparameters
        )
